...
import { styleMap, sizesMap } from "./data";
import type { LoadingImageProps, StaticImageProps } from "./data";

export default function({ id, src, alt, look, className, onLoad, ...props }: LoadingImageProps) {
